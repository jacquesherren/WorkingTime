...
public class CompanyAsyncTask extends AsyncTask<Void, Void, List<Company>> {
    private static CompanyApi myApiCompanyService = null;
    private Context context;
    private static final String TAG = CompanyAsyncTask.class.getName();
    private Company company;

    public CompanyAsyncTask(Company company)
    {
