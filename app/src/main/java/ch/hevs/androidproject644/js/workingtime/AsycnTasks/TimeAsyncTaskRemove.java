...
public class TimeAsyncTaskRemove extends AsyncTask<Void, Void, List<Time>> {
    private static TimeApi myApiTimeService = null;
    private static final String TAG = TimeAsyncTaskRemove.class.getName();

    public TimeAsyncTaskRemove()
    {
