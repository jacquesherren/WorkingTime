 ...
 */
public class ReportingByActivity extends Fragment {
    ...
    public ReportingByActivity() {
        // Required empty public constructor
    }

    public static ReportingByActivity newInstance(int page, String title) {
        ReportingByActivity reportingList = new ReportingByActivity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.reporting_byactivity, container, false);
        ...
        _btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((_fromDate!=null) && (_toDate!=null)){
                    ...
                    ActivityDataSource getTimeByActivity = new ActivityDataSource(reportingActivity);
                    List<Activity> activities = getTimeByActivity.getSumTimeByActivitybetweenDate(_fromDate.getTimeInMillis(),_toDate.getTimeInMillis());

                    ListView listView = (ListView) view.findViewById(R.id.lv_reporting);
                    ActivityAdapter adpter = new ActivityAdapter(view.getContext(),R.layout.activity_row,activities);
