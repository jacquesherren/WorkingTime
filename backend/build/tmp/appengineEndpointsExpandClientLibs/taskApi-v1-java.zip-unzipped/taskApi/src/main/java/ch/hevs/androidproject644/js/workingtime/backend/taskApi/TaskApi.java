...
package ch.hevs.androidproject644.js.workingtime.backend.taskApi;
...
public class TaskApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the taskApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Get extends TaskApiRequest<ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task> {

    private static final String REST_PATH = "task/{_id}";
    ...
    protected Get(java.lang.Long id) {
      super(TaskApi.this, "GET", REST_PATH, null, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task.class);
   ...
   *
   * @param content the {@link ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task}
   * @return the request
   */
  public Insert insert(ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends TaskApiRequest<ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Insert(ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) {
      super(TaskApi.this, "POST", REST_PATH, content, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task.class);
    }
  ...
  public class List extends TaskApiRequest<ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.CollectionResponseTask> {
     ...
     */
    protected List() {
      super(TaskApi.this, "GET", REST_PATH, null, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.CollectionResponseTask.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long id, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends TaskApiRequest<ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long id, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) {
      super(TaskApi.this, "PATCH", REST_PATH, content, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long id, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends TaskApiRequest<ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long id, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task content) {
      super(TaskApi.this, "PUT", REST_PATH, content, ch.hevs.androidproject644.js.workingtime.backend.taskApi.model.Task.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
