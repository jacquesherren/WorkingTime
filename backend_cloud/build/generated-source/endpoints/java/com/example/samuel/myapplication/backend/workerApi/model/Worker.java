...
package com.example.samuel.myapplication.backend.workerApi.model;
...
public final class Worker extends com.google.api.client.json.GenericJson {
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key("_birthdate")
   ...
   */
  public Worker setBirthdate(Calendar birthdate) {
   ...
   */
  public Worker setId(java.lang.Integer id) {
    this.id = id;
    return this;
  }
