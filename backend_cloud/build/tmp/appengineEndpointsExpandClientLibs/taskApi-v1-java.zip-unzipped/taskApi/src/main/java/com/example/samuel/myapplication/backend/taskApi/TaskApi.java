...
package com.example.samuel.myapplication.backend.taskApi;
...
public class TaskApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends TaskApiRequest<com.example.samuel.myapplication.backend.taskApi.model.Task> {
    ...
    protected Get(java.lang.Integer id) {
      super(TaskApi.this, "GET", REST_PATH, null, com.example.samuel.myapplication.backend.taskApi.model.Task.class);
   ...
   *
   * @param content the {@link com.example.samuel.myapplication.backend.taskApi.model.Task}
   * @return the request
   */
  public Insert insert(com.example.samuel.myapplication.backend.taskApi.model.Task content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends TaskApiRequest<com.example.samuel.myapplication.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Insert(com.example.samuel.myapplication.backend.taskApi.model.Task content) {
      super(TaskApi.this, "POST", REST_PATH, content, com.example.samuel.myapplication.backend.taskApi.model.Task.class);
    }
  ...
  public class List extends TaskApiRequest<com.example.samuel.myapplication.backend.taskApi.model.CollectionResponseTask> {
     ...
     */
    protected List() {
      super(TaskApi.this, "GET", REST_PATH, null, com.example.samuel.myapplication.backend.taskApi.model.CollectionResponseTask.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Integer id, com.example.samuel.myapplication.backend.taskApi.model.Task content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends TaskApiRequest<com.example.samuel.myapplication.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Integer id, com.example.samuel.myapplication.backend.taskApi.model.Task content) {
      super(TaskApi.this, "PATCH", REST_PATH, content, com.example.samuel.myapplication.backend.taskApi.model.Task.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Integer id, com.example.samuel.myapplication.backend.taskApi.model.Task content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends TaskApiRequest<com.example.samuel.myapplication.backend.taskApi.model.Task> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Integer id, com.example.samuel.myapplication.backend.taskApi.model.Task content) {
      super(TaskApi.this, "PUT", REST_PATH, content, com.example.samuel.myapplication.backend.taskApi.model.Task.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
